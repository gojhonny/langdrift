...
The package tests use temporary customer repositories. They cover setup, idempotency, Markdown preservation, partial repair, conflicts before writes, version rejection, symlink handling, safe integration references and noninteractive CLI behavior. They do not touch the monorepo's generated protocol, audit or agent harness directories.
