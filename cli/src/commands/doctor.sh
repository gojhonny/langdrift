...
for path in apps/dashboard apps/website apps/sso apps/mobile apps/docs packages/react packages/design-tokens packages/events messaging/infrastructure messaging/runtime/early-access cli/drift .agents; do
